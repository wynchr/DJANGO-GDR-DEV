...
=======================================================================================================================
.DESCRIPTION
    Import AD search to ORACLE PROV_AD
    Copy from PS
...
.COMMENTS
    Copy AD to ORACLE
    ------------------------------------------------------------------------------------------------
    AD(OU=IAM,OU=Users,OU=OSIRIS,DC=chu-brugmann,DC=be)		ORACLE (REFID_IOP_PROV_AD)
    ------------------------------------------------------------------------------------------------
...
# os.system("python create_REFID_IOP_PROV_AD.py")

logging.info(f"Synchronize Oracle Table (SA.REFID_IOP_PROV_AD) with AD")
...
try:
    ...
    for data in users:
        ...
        user['MESSAGES'] = "Create PROV From AD OSIRIS OU=IAM"

        sql_query = f"""
        INSERT INTO SA.REFID_IOP_PROV_AD (
            SAMACCOUNTNAME,
            SN,
            GIVENNAME,
            USUALSN,
