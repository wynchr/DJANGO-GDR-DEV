...
.COMMENTS
    -- Update CardType = NISS if len(NISS) = 11 PROV_AD
    ...
    -- REFID_IOP_PROVINIT_AD
    UPDATE SA.REFID_IOP_PROV_AD SET CARDTYPE = 'NISS' WHERE LENGTH(EMPLOYEENUMBER) = 11

    UPDATE SA.REFID_IOP_PROV_AD SET CARDTYPE = 'AUTRE' WHERE LENGTH(EMPLOYEENUMBER) != 11
====================================================================================================
"""
# =========================================
# Import modules
...
sql_query = "UPDATE SA.REFID_IOP_PROV_AD SET CARDTYPE = 'NISS' WHERE LENGTH(EMPLOYEENUMBER) = 11"
result = oracle_IT.exec_ddl_sql(sql_query)
logging.info(f"Update CardType = NISS : {result}")

sql_query = "UPDATE SA.REFID_IOP_PROV_AD SET CARDTYPE = 'AUTRE' WHERE LENGTH(EMPLOYEENUMBER) != 11"
result = oracle_IT.exec_ddl_sql(sql_query)
