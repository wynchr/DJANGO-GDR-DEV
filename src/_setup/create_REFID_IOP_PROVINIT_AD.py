...
.DESCRIPTION
    ...
    Create Oracle Table (SA.REFID_IOP_PROVINIT_AD)
    Copy from PS
...
.COMMENTS
    CREATE TABLE SA.REFID_IOP_PROVINIT_AD (
    ...
    CONSTRAINT REFID_IOP_PROVINIT_AD_PK PRIMARY KEY (SAMACCOUNTNAME)
    )
=======================================================================================================================
"""
# =========================================
...
def Drop_REFID_IOP_PROVINIT_AD():
    sql_query = "DROP TABLE SA.REFID_IOP_PROVINIT_AD"
    dataset = oracle_IT.exec_ddl_sql(sql_query)
    return dataset


def Create_REFID_IOP_PROVINIT_AD():
    sql_query = f"""
    CREATE TABLE SA.REFID_IOP_PROVINIT_AD (
            SAMACCOUNTNAME 				VARCHAR2(10), 
...
logging.info(f"Create Oracle Table (SA.REFID_IOP_PROVINIT_AD) for DB:{DB}")
...
try:
    logging.info(f"Drop_REFID_IOP_PROVINIT_AD")
    dataset = Drop_REFID_IOP_PROVINIT_AD()
    logging.info(f"{dataset}")
except:
    logging.info(f"Table do not exist")

try:
    logging.info(f"Create_REFID_IOP_PROVINIT_AD")
    dataset = Create_REFID_IOP_PROVINIT_AD()
    logging.info(f"{dataset}")
except:
