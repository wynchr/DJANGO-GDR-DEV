...
def Add_Groups_in_DB(groups, grouptype):
    ...
    for group in groups['entries']:
        ...
        sql_query = f"""
            INSERT INTO SA.REFID_IOP_REFADGROUPS_CWY (
                    SAMACCOUNTNAME,
                    DISTINGUISHEDNAME,
                    MAIL,
                    GROUPCATEGORY,
...
def Get_REFID_IOP_REFADGROUPS_CWY():
    sql_query = "select * from SA.REFID_IOP_REFADGROUPS_CWY"
...
# os.system("python create_REFID_IOP_REFADGROUPS_CWY.py")
...
try:
    logging.info(f"Get_REFID_IOP_REFADGROUPS_CWY")
    dataset = Get_REFID_IOP_REFADGROUPS_CWY()
