...
.DESCRIPTION
    ...
    Create Oracle Table (SA.REFID_IOP_REFADGROUPS_CWY)
    Copy from PS
...
.COMMENTS
    CREATE TABLE SA.REFID_IOP_REFADGROUPS_CWY (
        ...
        ENV							VARCHAR2(5)
    CONSTRAINT REFID_IOP_REFADGROUPS_CWY_PK PRIMARY KEY (SAMACCOUNTNAME)
    )
=======================================================================================================================
"""
# =========================================
...
def Drop_REFID_IOP_REFADGROUPS_CWY():
    sql_query = "DROP TABLE SA.REFID_IOP_REFADGROUPS_CWY"
    dataset = oracle_IT.exec_ddl_sql(sql_query)
    return dataset


def Create_REFID_IOP_REFADGROUPS_CWY():
    sql_query = f"""
    CREATE TABLE SA.REFID_IOP_REFADGROUPS_CWY (
				...
				OBJECTSID					VARCHAR2(50),
				ENV							VARCHAR2(5),
				CONSTRAINT REFID_IDREFADGROUPS_CWY_PK PRIMARY KEY (ID)
			   )
    """
    dataset = oracle_IT.exec_ddl_sql(sql_query)
    return dataset
...
def CreateIndex_REFID_IOP_REFADGROUPS_CWY():
    sql_query = "CREATE INDEX SA.REFID_REFADGROUPS_CWY_PK ON SA.REFID_IOP_REFADGROUPS_CWY (SAMACCOUNTNAME)"
    dataset = oracle_IT.exec_ddl_sql(sql_query)
    return dataset
...
logging.info(f"Create Oracle Table (SA.REFID_IOP_REFADGROUPS_CWY) for DB:{DB}")
...
try:
    logging.info(f"Drop_REFID_IOP_REFADGROUPS_CWY")
    dataset = Drop_REFID_IOP_REFADGROUPS_CWY()
    logging.info(f"{dataset}")
except:
    logging.info(f"Table do not exist")

try:
    logging.info(f"Create_REFID_IOP_REFADGROUPS_CWY")
    dataset = Create_REFID_IOP_REFADGROUPS_CWY()
    logging.info(f"{dataset}")
except:
    logging.info(f"Cannot create table")

try:
    logging.info(f"CreateIndex_REFID_IOP_REFADGROUPS_CWY")
    dataset = CreateIndex_REFID_IOP_REFADGROUPS_CWY()
    logging.info(f"{dataset}")
except:
    logging.info(f"Cannot create table")
