...
=======================================================================================================================
.DESCRIPTION
    Import AD search to ORACLEPROVMIRROR_AD
    Copy from PS
...
.COMMENTS
    Copy AD to ORACLE
    ------------------------------------------------------------------------------------------------
    AD(OU=IAM,OU=Users,OU=OSIRIS,DC=chu-brugmann,DC=be)		ORACLE (REFID_IOP_PROVMIRROR_AD)
    ------------------------------------------------------------------------------------------------
...
# os.system("python create_REFID_IOP_PROVMIRROR_AD.py")

logging.info(f"Synchronize Oracle Table (SA.REFID_IOP_PROVMIRROR_AD) with AD")
...
try:
    ...
    for data in users:
        ...
        user['MESSAGES'] = "Create PROVMIRROR From AD OSIRIS OU=IAM"

        sql_query = f"""
        INSERT INTO SA.REFID_IOP_PROVMIRROR_AD (
            SAMACCOUNTNAME,
            SN,
            GIVENNAME,
            USUALSN,
