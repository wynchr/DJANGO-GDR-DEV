...
====================================================================================================
.DESCRIPTION
    Run ALL scripts to fill PROV_AD
...
.COMMENTS
    update_provad_with_cacherh.py
    update_provad_with_cacheevidian.py
    update_provad_quality.py
    update_provad_cardtype.py
====================================================================================================
"""
# =========================================
# Import modules
...
os.system("python update_provad_with_cacherh.py")

os.system("python update_provad_with_cacheevidian.py")

os.system("python update_provad_quality.py")

os.system("python update_provad_cardtype.py")
